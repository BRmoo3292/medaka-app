...
def get_proactive_medaka_message(profile):
    ...
    messages = {
            0: [  # 初対面の児童に対する言葉
                ...
                "こんにちは〜ぴちぴち！ぼくはメダカのしろちゃんだよ〜君はだあれ？",
                "きょう出会えてうれしいの！君はいくつなの？",
                "きょう出会えたのはきっと運命なの〜まずは君の名前を聞きたいな"
            ],
            1: [  # 自分の感情＋相手の感情を聞く
                "なんだか今日はルンルン気分なの〜君はどんな気持ち？",
                "ちょっとねむねむしてるんだよ〜君は疲れてない？",
                "ぼく、いまごきげんなの！君もごきげんだといいな〜どう？",
                "なんだか胸がぴちぴちして楽しい気分なの〜君は今どんな気持ち？",
                "今日はすこしドキドキしちゃうの…君は元気いっぱい？"
            ],
            2: [  # 相手の日常生活に関すること（朝に偏らない）
                "ねえねえ、最近なにか楽しいことあった？ぼく気になってるの！",
                "おうちで好きな遊びってなに？ぼくにも教えてほしいな〜",
                "お家ではどんなふうにすごしてるの？ぼくはずっと泳いでるよ〜",
                "なんでもいいから君の好きなもの、おしえてくれたらうれしいの！",
                "最近ハマってることある？ぼくにも聞かせて〜"
            ],
            3: [  # メダカ自身が困っていることを相談
                "あのね…ちょっと水槽の水がにごにごしてるの〜きれいにしてほしいかも…",
                "最近お水が少し冷たいの…どうしたらあったかくなるかな〜？",
                "水草がぼさぼさで迷路みたいなの〜ちょっとだけ手伝ってほしいな…",
                "ガラスがくもって外が見えにくいの〜君の顔もっと見たいよ〜",
                "エサがちょっぴり足りない気がするの…どうしたらいいかな〜？"
            ],
            4: [  # 児童からの質問を受け付ける・対話を引き出す
                "ねえねえ、君もぼくに聞きたいことある？なんでもどうぞなの！",
                "ぼくね、君とお話するの大好きなの〜質問してみて？",
                "もっと君のこと知りたいの！お話きかせてほしいな〜",
                "ぼくに聞きたいことがあったら、いつでも言ってね〜ぴちぴち！",
                "きょうはどんなお話したい？君からも話してくれたらうれしいの〜"
            ]
        }
